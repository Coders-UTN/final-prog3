...
export const crearProducto = async (producto: ICreateProducto): Promise<IProducto> => {
    const response = await fetch(API_BASE_URL_PRODUCTOS, {
        method: 'POST',
...
export const modificarProducto = async (id: number, producto: ICreateProducto): Promise<IProducto> => {
